...
@export var box_margin_top: int = 15
@export var box_margin_left: int = 15
@export var box_margin_right: int = 15
...
func _apply_export_overrides() -> void:
	...
	sizer.size = box_size
	sizer.position = box_size * Vector2(-0.5, -1)+Vector2(-box_margin_right, -box_margin_bottom)
